...
import {GRAY, ONLINE, White} from '../../themes/constantColors';
    ...
    <View
      ...
      <View style={styles.buttonView}>
        ...
        {/* <View style={styles.loginView}>
          <Text style={[styles.loginText, {color: props.theme.secondaryColor}]}>
            Already have an account ?{' '}
          </Text>
          <TouchableOpacity onPress={() => props.navigation.navigate('LoginScreen')}>
            <Text
              style={[styles.loginText, {color: '#008069', fontWeight: '600'}]}>
              Log In
            </Text>
          </TouchableOpacity>
        </View> */}
