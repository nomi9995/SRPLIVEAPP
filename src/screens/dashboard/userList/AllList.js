  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <SafeAreaView style={{ backgroundColor: '#008069' }}>
          {this.state.searchList ?
            <View style={{ flexDirection: 'row', alignItems: 'center',paddingVertical:15 }}>
              <TouchableOpacity
                onPress={() => this.setState({ searchList: false, searchQueryUSerList: '', searchUserList: [] })}
            ...
            <View style={styles.headerView}>
              ...
              <TouchableOpacity
                style={[styles.settingText, { paddingHorizontal: '2%', marginRight: '3%' }]}
        ...
        {this.state.searchList ? (
          <UserSearchList navProps={this.props}
            searchuserlistCom={this.state.searchUserList}
            messageUserList={this.state.messageUserList}
